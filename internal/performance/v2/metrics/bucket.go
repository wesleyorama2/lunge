...
//
// Parameters:
//   - totalRequests: Total requests since test start (from MetricsEngine)
//   - totalSuccesses: Total successful requests since test start
//   - totalFailures: Total failed requests since test start
//   - totalBytes: Total bytes received since test start
//   - latencies: Latency percentiles from HDR histogram
//   - activeVUs: Current number of active virtual users
